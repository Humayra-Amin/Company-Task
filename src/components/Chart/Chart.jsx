    ...
    return (
        <div className="relative bg-white h-[810px] lg:h-[630px] mt-20 lg:mt-20">
            <div className="relative bg-white lg:h-full flex items-center justify-center">
                <div className="absolute lg:w-[97%] lg:top-8">
                    <div className="sticky top-0 navbar bg-[#F3F3F3] z-50 rounded-lg mb-[240px] lg:mb-0">
                        <div className="flex-1">
                            <a className="text-xl">
                                <img src={logo} className='w-[6rem] lg:w-auto mr-[1rem] lg:mr-0'/>
                            </a>
                        </div>
                        <div className="flex items-center">
                            <div className="text-white mr-4 lg:mr-4">
                                <img src={share} className="border border-black rounded-full p-2 lg:p-2" />
                            </div>
                            <button className="btn bg-[#F3F3F3] border border-blue-600 rounded-full mr-4 text-black font-normal w-[100px] lg:w-auto hover:bg-slate-400">
                                Download the 2024 Report
                            </button>
                            <button onClick={toggleMenu} className="btn text-black bg-[#F3F3F3] border-none hover:bg-slate-400 w-[3rem] lg:w-auto">
                ...
                <div className="absolute left-0 lg:left-0 ml-[5.5rem] lg:ml-6 mt-[38rem] lg:mt-[5rem] lg:w-[224px] lg:h-[470px] bg-[#F3F3F3] lg:p-4 rounded-lg">
                ...
                <div className="flex flex-col items-center lg:mb-[12.5rem] mt-[6.5rem] lg:mt-0">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6 lg:mt-6 lg:ml-[215px]">
                        <div className="flex items-center bg-[#F3F3F3] lg:p-2 rounded-lg gap-8 relative">
                            ...
                            <p className="mr-[1.5rem] lg:mr-2 text-[12px] font-semibold text-right font2 text-black">WPPOOL<br />Index</p>
                            <div className="h-[50%] w-[4px] bg-[#FC714D] absolute lg:top-4 lg:bottom-0 right-2 lg:right-2"></div>
                        </div>
                        <div className="flex items-center bg-[#F3F3F3] lg:p-2 rounded-lg gap-8 relative">
                            <h4 className="lg:text-3xl font1 text-[#615DE3]">+26.6%</h4>
                            <p className="lg:ml-2 text-[12px] font-semibold text-right font2 text-black">Google<br />Index</p>
                            <div className="h-[50%] w-[4px] bg-[#615DE3] absolute lg:top-4 lg:bottom-0 right-2 lg:right-2"></div>
                        </div>
                        <div className="flex items-center bg-[#F3F3F3] lg:p-2 rounded-lg gap-8 relative">
                            ...
                            <div className="h-[50%] w-[4px] bg-[#7CA63A] absolute lg:top-4 lg:bottom-0 right-2 lg:right-2"></div>
                        </div>
                        <div className="flex items-center bg-[#F3F3F3] lg:p-2 rounded-lg gap-8 relative">
                            ...
                            <div className="h-[50%] w-[4px] bg-[#6F34A1] absolute lg:top-4 lg:bottom-0 right-2 lg:right-2"></div>
                        </div>
                    </div>
                    ...
                    <div className="flex mt-6 lg:mt-6 lg:w-full justify-between lg:px-[215px] relative">
                        <div className="flex lg:flex-row gap-10 mt-[24px] lg:mt-0">
                            <div className="w-[140px] lg:w-[210px] lg:h-[30px] flex items-center justify-between px-[1rem] lg:px-3 bg-[#2042B6] rounded-full shadow-lg">
                                <p className="text-sm text-white font2">Sectors</p>
                                <img src={dropdown} className="lg:w-6 lg:h-6 ml-10 lg:ml-0" />
                            </div>
                            <div className="w-[164px] lg:w-[210px] lg:h-[30px] flex items-center justify-between px-3 lg:px-3 bg-[#2042B6] rounded-full shadow-lg">
                                <p className="text-sm text-white font2">Types of IPO</p>
                                <img src={dropdown} className="lg:w-6 lg:h-6 ml-10 lg:ml-2" />
                            </div>
                        </div>
                        <div className="absolute right-[85px] lg:right-0">
                            <div className="flex items-center w-[180px] lg:w-[232px] lg:h-[30px] bg-[#EFF3F6] rounded-full justify-between text-[#748DA1] font2 px-4 lg:">
